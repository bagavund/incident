...
Интерфейс минималистичный: тёмная тема по умолчанию (есть светлая),
приглушённые границы, зелёный акцент точечно, шрифт IBM Plex Sans;
моноширинный — только для идентификаторов инцидентов.
