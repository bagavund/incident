...
Интерфейс — на дизайн-системе Азбуки Вкуса: светлая тема по умолчанию
(тёмная — переключателем в «Настройках»), шрифт Golos Text, приглушённая
серая палитра, зелёный акцент точечно. Статус несут отдельные цвета
(красный / золото / синий), зелёный означает «хорошо».
